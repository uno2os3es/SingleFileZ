...
function injectedScript() {
  ...
  if (globalThis.FontFace) {
    ...
    globalThis.FontFace = function () {
      getDetailObject(...arguments).then((detail) =>
        document.dispatchEvent(new CustomEvent(NEW_FONT_FACE_EVENT, { detail }))
      );
    ...
    document.fonts.delete = function (fontFace) {
      getDetailObject(fontFace.family).then((detail) =>
        document.dispatchEvent(new CustomEvent(DELETE_FONT_EVENT, { detail }))
      );
      return deleteFont.call(document.fonts, fontFace);
    };
    document.fonts.delete.toString = function () {
    ...
    document.fonts.clear.toString = function () {
