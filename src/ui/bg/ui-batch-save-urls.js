...
addUrlsButton.textContent = browser.i18n.getMessage(
  'batchSaveUrlsAddUrlsButton'
);
removeAllButton.textContent = browser.i18n.getMessage(
  'batchSaveUrlsRemoveAllButton'
);
saveUrlsButton.textContent = browser.i18n.getMessage(
