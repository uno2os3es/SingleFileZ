...
const acceptHeaderDocumentLabel = document.getElementById(
  'acceptHeaderDocumentLabel'
);
const acceptHeaderScriptLabel = document.getElementById(
  'acceptHeaderScriptLabel'
);
const acceptHeaderAudioLabel = document.getElementById(
  'acceptHeaderAudioLabel'
);
const acceptHeaderVideoLabel = document.getElementById(
  'acceptHeaderVideoLabel'
);
const acceptHeaderFontLabel = document.getElementById('acceptHeaderFontLabel');
const acceptHeaderStylesheetLabel = document.getElementById(
  'acceptHeaderStylesheetLabel'
);
const acceptHeaderImageLabel = document.getElementById(
  'acceptHeaderImageLabel'
);
...
const insertEmbeddedImageLabel = document.getElementById(
  'insertEmbeddedImageLabel'
);
...
const loadDeferredImagesDispatchScrollEventLabel = document.getElementById(
  'loadDeferredImagesDispatchScrollEventLabel'
);
const loadDeferredImagesBeforeFramesLabel = document.getElementById(
  'loadDeferredImagesBeforeFramesLabel'
);
...
const filenameMaxLengthBytesUnitLabel = document.getElementById(
  'filenameMaxLengthBytesUnitLabel'
);
const filenameMaxLengthCharsUnitLabel = document.getElementById(
  'filenameMaxLengthCharsUnitLabel'
);
const filenameReplacementCharacterLabel = document.getElementById(
  'filenameReplacementCharacterLabel'
);
const replaceEmojisInFilenameLabel = document.getElementById(
  'replaceEmojisInFilenameLabel'
);
const saveFilenameTemplateDataLabel = document.getElementById(
  'saveFilenameTemplateDataLabel'
);
...
const setMaxResourceDelayLabel = document.getElementById(
  'setMaxResourceDelayLabel'
);
...
const createRootDirectoryLabel = document.getElementById(
  'createRootDirectoryLabel'
);
const preventAppendedDataLabel = document.getElementById(
  'preventAppendedDataLabel'
);
const passwordLabel = document.getElementById('passwordLabel');
const selfExtractingArchiveLabel = document.getElementById(
  'selfExtractingArchiveLabel'
);
const extractDataFromPageLabel = document.getElementById(
  'extractDataFromPageLabel'
);
...
const displayInfobarInEditorLabel = document.getElementById(
  'displayInfobarInEditorLabel'
);
...
const removeInfobarSavedDateLabel = document.getElementById(
  'removeInfobarSavedDateLabel'
);
...
const acceptHeaderDocumentInput = document.getElementById(
  'acceptHeaderDocumentInput'
);
const acceptHeaderScriptInput = document.getElementById(
  'acceptHeaderScriptInput'
);
const acceptHeaderAudioInput = document.getElementById(
  'acceptHeaderAudioInput'
);
const acceptHeaderVideoInput = document.getElementById(
  'acceptHeaderVideoInput'
);
const acceptHeaderFontInput = document.getElementById('acceptHeaderFontInput');
const acceptHeaderStylesheetInput = document.getElementById(
  'acceptHeaderStylesheetInput'
);
const acceptHeaderImageInput = document.getElementById(
  'acceptHeaderImageInput'
);
...
const insertEmbeddedImageInput = document.getElementById(
  'insertEmbeddedImageInput'
);
...
const loadDeferredImagesDispatchScrollEventInput = document.getElementById(
  'loadDeferredImagesDispatchScrollEventInput'
);
const loadDeferredImagesBeforeFramesInput = document.getElementById(
  'loadDeferredImagesBeforeFramesInput'
);
...
const filenameMaxLengthUnitInput = document.getElementById(
  'filenameMaxLengthUnitInput'
);
const filenameReplacementCharacterInput = document.getElementById(
  'filenameReplacementCharacterInput'
);
const replaceEmojisInFilenameInput = document.getElementById(
  'replaceEmojisInFilenameInput'
);
const saveFilenameTemplateDataInput = document.getElementById(
  'saveFilenameTemplateDataInput'
);
...
const maxResourceDelayEnabledInput = document.getElementById(
  'maxResourceDelayEnabledInput'
);
...
const createRootDirectoryInput = document.getElementById(
  'createRootDirectoryInput'
);
const preventAppendedDataInput = document.getElementById(
  'preventAppendedDataInput'
);
const passwordInput = document.getElementById('passwordInput');
const selfExtractingArchiveInput = document.getElementById(
  'selfExtractingArchiveInput'
);
const extractDataFromPageInput = document.getElementById(
...
const removeInfobarSavedDateInput = document.getElementById(
  'removeInfobarSavedDateInput'
);
...
const displayInfobarInEditorInput = document.getElementById(
  'displayInfobarInEditorInput'
);
...
saveToDropboxInput.addEventListener(
  'click',
  () =>
    disableDestinationPermissions(
      ['clipboardWrite', 'nativeMessaging'],
      true,
      false
    ),
  false
);
saveWithWebDAVInput.addEventListener(
  'click',
  () => disableDestinationPermissions(['clipboardWrite', 'nativeMessaging']),
  false
);
...
blockStylesheetsLabel.textContent = browser.i18n.getMessage(
  'optionResourceStylesheet'
);
blockImagesLabel.textContent = browser.i18n.getMessage('optionResourceImage');
acceptHeaderDocumentLabel.textContent = browser.i18n.getMessage(
  'optionResourceDocument'
);
acceptHeaderScriptLabel.textContent = browser.i18n.getMessage(
  'optionResourceScript'
);
acceptHeaderAudioLabel.textContent = browser.i18n.getMessage(
  'optionResourceAudio'
);
acceptHeaderVideoLabel.textContent = browser.i18n.getMessage(
  'optionResourceVideo'
);
acceptHeaderFontLabel.textContent =
  browser.i18n.getMessage('optionResourceFont');
acceptHeaderStylesheetLabel.textContent = browser.i18n.getMessage(
  'optionResourceStylesheet'
);
acceptHeaderImageLabel.textContent = browser.i18n.getMessage(
  'optionResourceImage'
);
...
saveWithWebDAVLabel.textContent = browser.i18n.getMessage(
...
webDAVPasswordLabel.textContent = browser.i18n.getMessage(
...
insertTextBodyLabel.textContent = browser.i18n.getMessage(
  'optionInsertTextBody'
);
insertEmbeddedImageLabel.textContent = browser.i18n.getMessage(
...
loadDeferredImagesDispatchScrollEventLabel.textContent =
  browser.i18n.getMessage('optionLoadDeferredImagesDispatchScrollEvent');
loadDeferredImagesBeforeFramesLabel.textContent = browser.i18n.getMessage(
...
filenameMaxLengthBytesUnitLabel.textContent = browser.i18n.getMessage(
  'optionFilenameMaxLengthBytesUnit'
);
filenameMaxLengthCharsUnitLabel.textContent = browser.i18n.getMessage(
  'optionFilenameMaxLengthCharsUnit'
);
filenameReplacementCharacterLabel.textContent = browser.i18n.getMessage(
  'optionFilenameReplacementCharacter'
);
replaceEmojisInFilenameLabel.textContent = browser.i18n.getMessage(
  'optionReplaceEmojisInFilename'
);
saveFilenameTemplateDataLabel.textContent = browser.i18n.getMessage(
...
setMaxResourceDelayLabel.textContent = browser.i18n.getMessage(
  'optionSetMaxResourceDelay'
);
maxResourceDelayLabel.textContent = browser.i18n.getMessage(
...
createRootDirectoryLabel.textContent = browser.i18n.getMessage(
  'optionCreateRootDirectory'
);
preventAppendedDataLabel.textContent = browser.i18n.getMessage(
  'optionPreventAppendedData'
);
passwordLabel.textContent = browser.i18n.getMessage('optionPassword');
selfExtractingArchiveLabel.textContent = browser.i18n.getMessage(
  'optionSelfExtractingArchive'
);
extractDataFromPageLabel.textContent = browser.i18n.getMessage(
  'optionExtractDataFromPage'
);
...
zipContentLabel.textContent = browser.i18n.getMessage(
  'optionsZipContentSubTitle'
);
...
blockResourcesLabel.textContent = browser.i18n.getMessage(
  'optionsBlockedResources'
);
acceptHeadersLabel.textContent = browser.i18n.getMessage(
...
removeInfobarSavedDateLabel.textContent = browser.i18n.getMessage(
...
displayInfobarInEditorLabel.textContent = browser.i18n.getMessage(
...
async function refresh(profileName) {
  ...
  saveToFilesystemInput.checked =
    ...
    !profileOptions.saveWithWebDAV &&
    !profileOptions.saveToDropbox;
  ...
  loadDeferredImagesMaxIdleTimeInput.disabled =
    !profileOptions.loadDeferredImages;
  loadDeferredImagesDispatchScrollEventInput.checked =
    profileOptions.loadDeferredImagesDispatchScrollEvent;
  loadDeferredImagesDispatchScrollEventInput.disabled =
    !profileOptions.loadDeferredImages;
  loadDeferredImagesBeforeFramesInput.checked =
    profileOptions.loadDeferredImagesBeforeFrames;
  loadDeferredImagesBeforeFramesInput.disabled =
    !profileOptions.loadDeferredImages;
  ...
  filenameReplacementCharacterInput.value =
    profileOptions.filenameReplacementCharacter;
  replaceEmojisInFilenameInput.checked = profileOptions.replaceEmojisInFilename;
  saveFilenameTemplateDataInput.checked =
    profileOptions.saveFilenameTemplateData;
  ...
  maxResourceSizeInput.value = profileOptions.maxResourceSizeEnabled
    ? profileOptions.maxResourceSize
    : 10;
  ...
  maxResourceDelayInput.value = profileOptions.networkTimeout
    ? profileOptions.networkTimeout / 1000
    : 60;
  ...
  preventAppendedDataInput.disabled =
    !profileOptions.compressContent && !profileOptions.selfExtractingArchive;
  ...
  insertTextBodyInput.disabled =
    !profileOptions.selfExtractingArchive &&
    !profileOptions.extractDataFromPage;
...
async function update() {
  ...
  pendingSave = browser.runtime.sendMessage({
    ...
    profile: {
      ...
      loadDeferredImagesMaxIdleTime: Math.max(
        loadDeferredImagesMaxIdleTimeInput.value,
        0
      ),
      ...
      maxResourceSize: maxResourceSizeEnabledInput.checked
        ? Math.max(maxResourceSizeInput.value, 0)
        : 10,
      networkTimeout: maxResourceDelayEnabledInput.checked
        ? Math.max(maxResourceDelayInput.value * 1000, 60)
        : 0,
