...
optionsTab.textContent = optionsTab.title =
  browser.i18n.getMessage('optionsTitle');
pendingsTab.textContent = pendingsTab.title =
  browser.i18n.getMessage('pendingsTitle');
batchSaveUrlsTab.textContent = batchSaveUrlsTab.title =
  browser.i18n.getMessage('batchSaveUrlsTitle');
