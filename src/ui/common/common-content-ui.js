...
const EMBEDDED_IMAGE_BUTTON_MESSAGE = browser.i18n.getMessage(
...
export { openFile, getOpenFileBar, onError };
  ...
  return {
    display: async function () {
      return new Promise((resolve) => {
        ...
        displayBar(OPEN_FILE_BAR_TAGNAME, '', {
          buttonLabel: EMBEDDED_IMAGE_BUTTON_MESSAGE,
...
function displayBar(
  tagName,
  message,
  { link, buttonLabel, buttonOnclick } = {}
) {
  try {
