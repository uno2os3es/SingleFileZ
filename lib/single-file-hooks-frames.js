!(function () {
  ...
  ((e) => {
    ...
    function w() {
      (a.addEventListener('single-file-load-deferred-images-start', () => F()),
        ...
        a.addEventListener(
          ...
          () => {
            const e = a.documentElement.style.getPropertyValue('-sf-transform'),
              ...
              n = a.documentElement.style.getPropertyValue(
                '-sf-transform-origin'
              ),
              i = a.documentElement.style.getPropertyPriority(
                '-sf-transform-origin'
              ),
        ...
        a.addEventListener('single-file-request-fetch', async (t) => {
          ...
          a.dispatchEvent(new d('single-file-response-fetch', { detail: r }));
        }),
    ...
    function F(r) {
      ...
      if (
        (a.querySelectorAll('[loading=lazy]').forEach((e) => {
          ((e.loading = 'eager'), e.setAttribute(t, ''));
        }),
        o.__defineGetter__('clientHeight', () => f),
        o.__defineGetter__('clientWidth', () => m),
        c.__defineGetter__('height', () => f),
        ...
        r ||
          ...
          ((e._singleFile_getBoundingClientRect =
            g.prototype.getBoundingClientRect),
          (g.prototype.getBoundingClientRect = function () {
          ...
          e.__defineGetter__('Image', function () {
            return function () {
              const e = new t(...arguments),
                r = new t(...arguments);
              return (
                r.__defineSetter__('src', (t) => {
                  ((e.src = t), a.dispatchEvent(new d(n, { detail: e.src })));
                }),
                r.__defineGetter__('src', () => e.src),
                r.__defineSetter__('srcset', (t) => {
                  (a.dispatchEvent(new d(n)), (e.srcset = t));
                }),
                r.__defineGetter__('srcset', () => e.srcset),
                r.__defineGetter__('height', () => e.height),
                r.__defineGetter__('width', () => e.width),
                r.__defineGetter__('naturalHeight', () => e.naturalHeight),
                r.__defineGetter__('naturalWidth', () => e.naturalWidth),
                e.decode &&
                  r.__defineGetter__('decode', () => () => e.decode()),
                (e.onload =
                  e.onloadend =
                  e.onerror =
                    (t) => {
                      (a.dispatchEvent(new d(i, { detail: e.src })),
      ...
      r
        ? ((u = l / f), (h = s / m))
        : ((u = (l + e.scrollY) / f), (h = (s + e.scrollX) / m));
      ...
      if (y < 1) {
        ...
        (a.documentElement.style.setProperty(
          ...
          G(),
          r
            ? (a.documentElement.style.setProperty('-sf-transform', e, t),
              a.documentElement.style.setProperty('-sf-transform-origin', n, i),
              a.documentElement.style.setProperty('-sf-min-height', o, l))
            : (a.documentElement.style.setProperty('transform', e, t),
              a.documentElement.style.setProperty('transform-origin', n, i),
              a.documentElement.style.setProperty('min-height', o, l)));
      }
      if (!r) {
        G();
    ...
    if ((w(), new y(w).observe(a, { childList: !0 }), e.FontFace)) {
      const t = e.FontFace;
      ((e.FontFace = function () {
        return (
          B(...arguments).then((e) =>
            a.dispatchEvent(new d('single-file-new-font-face', { detail: e }))
          ),
          new t(...arguments)
        );
      }),
      ...
      ((a.fonts.delete = function (e) {
        return (
          B(e.family).then((e) =>
            a.dispatchEvent(new d('single-file-delete-font', { detail: e }))
          ),
          n.call(a.fonts, e)
        );
      }),
      ...
      ((a.fonts.clear = function () {
        return (
          a.dispatchEvent(new d('single-file-clear-fonts')),
          i.call(a.fonts)
        );
      }),
          ...
          i &&
            (e.unobserve = function (t) {
              ...
              return (
                n &&
                  ((n = n.filter((e) => e != t)),
                  n.length ? E.set(e, n) : (E.delete(e), p.delete(e))),
                i.call(e, t)
              );
            }),
          p.set(e, { callback: r, options: o }),
          e
        );
      }),
    ...
    function S(e) {
      ...
      if ((e.stopPropagation(), t)) {
        (t.addEventListener(r, S, { capture: !0 }),
        ...
        e.length &&
          t.dispatchEvent(new d(l, { detail: { adoptedStyleSheets: e } }));
      }
    }
