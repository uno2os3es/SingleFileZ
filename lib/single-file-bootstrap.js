!(function (e, t) {
  ...
  const t = 'single-filez-load-deferred-images-start',
    ...
    a = 'single-filez-block-cookies-start',
    i = 'single-filez-block-cookies-end',
    ...
    m = 'single-filez-load-image',
    u = 'single-filez-image-loaded',
    p = '_singleFileZ_fontFaces',
  ...
  function y() {
    h instanceof f &&
      (h.addEventListener('single-filez-new-font-face', (e) => {
        const t = e.detail,
          s = Object.assign({}, t);
        (delete s.src, b.set(E.stringify(s), t));
      }),
      h.addEventListener('single-filez-delete-font', (e) => {
        const t = e.detail,
          s = Object.assign({}, t);
        (delete s.src, b.delete(E.stringify(s)));
      }),
      h.addEventListener('single-filez-clear-fonts', () => (b = new Map())));
  }
  ...
  const A = 'single-filez-',
    v = '_singleFileZ_waitForUserScript',
    S = '__sfz_frameTree__::',
  ...
  function de(e, t, s) {
    (e.querySelectorAll('noscript:not([' + G + '])').forEach((e) => {
      ...
      e.head && e.head.querySelectorAll(X).forEach((e) => (e.hidden = !0)),
      e.querySelectorAll('svg foreignObject').forEach((e) => {
        const t = e.querySelectorAll(
          'html > head > ' + X + ', html > body > ' + X
        );
        t.length &&
        ...
        ? (e.querySelectorAll('button button, a a').forEach((t) => {
          ...
          s.moveStylesInHead &&
            e.querySelectorAll('body style, body ~ style').forEach((e) => {
              ...
              s &&
                he(e, s) &&
                (e.setAttribute(B, ''), n.markedElements.push(e));
            }))
        : (n = {
            canvases: [],
            images: [],
          ...
          !(function (e, t, s, o, n, a, i) {
            ...
            if ('CANVAS' == r)
              try {
                (n.canvases.push({
                  ...
                  s.setAttribute(V, n.canvases.length - 1),
            ...
            if ('VIDEO' == r) {
              ...
              if (o && !o.startsWith('blob:') && !o.startsWith('data:')) {
                ...
                (n.videos.push({
                  ...
                  s.setAttribute(z, n.videos.length - 1));
              }
            ...
            'SCRIPT' == r &&
              (s.async &&
                ...
                (s.setAttribute(Z, ''), n.markedElements.push(s)),
  ...
  function fe(e, t, s) {
    if (
      ...
      const s = [O, x, L, F, k, H, z, V, W, U, j, Z];
  ...
  const Fe = {
    ...
    ze = 'singlefile.frameTree.cleanupRequest',
    Ve = 'singlefile.frameTree.initResponse',
    Be = '*',
    We = 5e3,
    Ye = 1e4,
    je = '.',
    ...
    globalThis.addEventListener(
      ...
      async (e) => {
        if ('string' == typeof e.data && e.data.startsWith(S)) {
          ...
          else if (t.method == ze) at(t);
          else if (t.method == Ve && tt.get(t.sessionId)) {
  ...
  function ct(e, t, s) {
    (e.forEach((e, o) => {
      ...
      try {
        ut(e.contentWindow, { method: ze, windowId: n, sessionId: s });
      } catch (e) {}
    }),
      e.forEach((e, o) => {
        const n = t + je + o;
  ...
  function mt(e) {
    e.method = Ve;
    try {
      Ze.singlefile.processors.frameTree.initResponse(e);
    } catch (t) {
      ut(Ze, e, !0);
    }
  }
  function ut(e, t, s) {
    if (e == Ze && Ke && Ke.runtime && Ke.runtime.sendMessage)
    ...
    } else e.postMessage(S + $e.stringify(t), Be);
  }
  ...
  const ht = [
    ...
    yt = [
      ...
      {
        tagName: 'OPTGROUP',
        accept: (e) => !e || ['OPTGROUP'].includes(vt(e)),
      },
      {
        tagName: 'OPTION',
        ...
        : e.nodeType == ft
          ? (function (e, t, s) {
              ...
              'TEMPLATE' != o || e.childNodes.length
                ...
                : (a += e.innerHTML);
              const i =
                t && yt.find((t) => o == vt(t) && t.accept(e.nextSibling, e));
              (s || (!i && !ht.includes(o))) &&
                (a += '</' + o.toLowerCase() + '>');
              return a;
            })(e, t, s)
  ...
  const St = {
      frameTree: Object.freeze({
        ...
        initResponse: it,
        TIMEOUT_INIT_REQUEST_MESSAGE: We,
      }),
    },
    Rt = {
