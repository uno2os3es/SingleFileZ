!(function () {
  ...
  if (e instanceof globalThis.Document) {
    let n = e.createElement('script');
    ((n.src = 'data:,(' + t.toString() + ')()'),
      (e.documentElement || e).appendChild(n),
      n.remove(),
  ...
  function t() {
    ...
    if (globalThis.FontFace) {
      ...
      ((globalThis.FontFace = function () {
        return (
          o(...arguments).then((n) =>
            e.dispatchEvent(new t('single-filez-new-font-face', { detail: n }))
          ),
          new n(...arguments)
        );
      }),
      ...
      ((e.fonts.delete = function (n) {
        return (
          o(n.family).then((n) =>
            e.dispatchEvent(new t('single-filez-delete-font', { detail: n }))
          ),
          r.call(e.fonts, n)
        );
      }),
      ...
      ((e.fonts.clear = function () {
        return (
          e.dispatchEvent(new t('single-filez-clear-fonts')),
          a.call(e.fonts)
        );
      }),
  ...
  const n = globalThis.browser,
    r = globalThis.document;
  if (r instanceof globalThis.Document && n && n.runtime && n.runtime.getURL) {
    const e = r.createElement('script');
    ((e.src = n.runtime.getURL('/lib/single-file-hooks-frames.js')),
      (e.async = !1),
      (r.documentElement || r).appendChild(e),
      e.remove());
  }
  let a = new Map();
    ...
    window.frameId == e.frameId
      ? (async function (e) {
          try {
            ...
            (n = { cache: 'force-cache', headers: e.headers }),
            window.fetch(t, n));
            return {
              status: r.status,
              headers: [...r.headers],
      ...
      : 'singlefile.fetchResponse' == e.method
        ? (async function (e) {
            const t = a.get(e.requestId);
            t &&
              (e.error
                ? (t.reject(new Error(e.error)), a.delete(e.requestId))
                : (e.truncated &&
                    (t.array
                      ? (t.array = t.array.concat(e.array))
                      : ((t.array = e.array), a.set(e.requestId, t)),
